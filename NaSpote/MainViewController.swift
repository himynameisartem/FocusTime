...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        showViewController(viewController: UINavigationController.self, storyboardId: "NewsID")
    }
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // News
            self.showViewController(viewController: UINavigationController.self, storyboardId: "NewsID")
        case 1:
            // Spots
            self.showViewController(viewController: UITabBarController.self, storyboardId: "tabBarID")
//        case 2:
//            // Camps
//            self.showViewController(viewController: UITabBarController.self, storyboardId: "tabBarID")
//        case 3:
