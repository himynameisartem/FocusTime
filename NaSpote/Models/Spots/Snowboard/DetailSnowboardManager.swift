...
protocol DetailSnowboardManagerDelegate {
    func didUpdateSpot(spot: DetailSnowboardModel)
    func didFailWithError(error: Error)
}

struct DetailSnowboardManager {
    
    var delegate: DetailSnowboardManagerDelegate?
//
...
//    var spotPhone = [String]()
        ...
        do {
            ...
            let detailSpot = DetailSnowboardModel(info: detailSpotInfo, contacts: detailSpotContacts, gallery: spotGallery)
